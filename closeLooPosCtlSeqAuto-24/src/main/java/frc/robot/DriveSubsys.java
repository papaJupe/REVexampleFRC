// closeLooPosCtlSeqAuto  - 24                          DriveSubsys.j
...
public class DriveSubsys extends SubsystemBase {
  ...
  // CAN bus leftMasterID = n;

  public CANSparkMax leftMaster = new CANSparkMax(16, MotorType.kBrushless);
  public static SparkPIDController leftPIDControl;
